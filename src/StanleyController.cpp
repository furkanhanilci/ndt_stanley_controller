...
void StanleyController::computeSteeringAngle(double current_yaw, double v){
    ...
    if (target_idx==0){
        ...
        diff_idx = target_idx-1;
    }

    /*
    cout << "new_waypoints[target_idx][1] " << new_waypoints[target_idx][1]<< endl;
    cout << "new_waypoints[target_idx-1][1] " << new_waypoints[diff_idx][1]<< endl;
    cout << "new_waypoints[target_idx][0] " << new_waypoints[target_idx][0]<< endl;
    cout << "new_waypoints[target_idx-1][0] " << new_waypoints[diff_idx][0]<< endl;
     */

    double yaw_target = std::atan2(new_waypoints[target_idx][1]-new_waypoints[diff_idx][1], new_waypoints[target_idx][0]-new_waypoints[diff_idx][0]);
